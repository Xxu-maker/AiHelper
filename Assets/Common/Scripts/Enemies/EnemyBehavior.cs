...
namespace OctoberStudio
{
    public class EnemyBehavior : MonoBehaviour
    {
        ...
        [Header("Hit-命中参数")]
        [Tooltip("The amount of scale the enemy will have when hit\n 敌人被击中时的缩放量")]
